...
public interface FortNightMapper {
	...
	@Mapping(target = "extras50", ignore = true)
	@Mapping(target = "extras100", ignore = true)
	...
	@Mapping(target = "holidayDay", ignore = true)
	@Mapping(target = "hours", ignore = true)
	@Mapping(target = "totalDeduction", ignore = true)
	@Mapping(target = "totalRetribution", ignore = true)
